...
export default () => {
    ...
    return (
        <footer className="text-gray-500 bg-white w-full dark:bg-black dark:text-gray-100">
            <div className="container flex flex-col flex-wrap justify-between py-5 mx-auto max-w-7xl">
